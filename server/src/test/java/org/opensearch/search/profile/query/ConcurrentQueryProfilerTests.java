...
public class ConcurrentQueryProfilerTests extends OpenSearchTestCase {
    ...
    public void testMergeRewriteTimeIntervals() {
        ConcurrentQueryProfiler profiler = new ConcurrentQueryProfiler(new ConcurrentQueryProfileTree(QueryProfileBreakdown.class), QueryProfileBreakdown.class);
        List<Timer> timers = new LinkedList<>();
        timers.add(new Timer(217134L, 1L, 1L, 0L, 553074511206907L, "test"));
        timers.add(new Timer(228954L, 1L, 1L, 0L, 553074509287335L, "test"));
        timers.add(new Timer(228954L, 1L, 1L, 0L, 553074509287336L, "test"));
