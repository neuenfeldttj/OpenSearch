...
public class ConcurrentQueryProfileBreakdownTests extends OpenSearchTestCase {
    ...
    @Before
    public void setup() {
        testQueryProfileBreakdown = new ConcurrentQueryProfileBreakdown(QueryProfileBreakdown.class);
    ...
    public void testBuildSliceLevelBreakdownWithSingleSlice() throws Exception {
        ...
        final ContextualProfileBreakdown leafProfileBreakdown = new TestQueryProfileBreakdown(
    ...
    public void testBuildSliceLevelBreakdownWithMultipleSlices() throws Exception {
        ...
        final ContextualProfileBreakdown leafProfileBreakdown_2 = new TestQueryProfileBreakdown(
